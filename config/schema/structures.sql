...
(
    ...
    constraint fk_pedido_produto foreign key (codigo_produto) references produto (codigo_produto),
    constraint uk_cliente_produto unique key (codigo_cliente, codigo_produto)
);